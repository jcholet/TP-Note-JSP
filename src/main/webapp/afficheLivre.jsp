...
<%
	if (session.getAttribute("panier")==null) {
		...
		List<Article> articles = catalogueManager.getLivres();
					...
					<div class="menu">
						<ul id="nav-menu">
							...
							<li class="page_item page-item-6">
								<form action="afficheRechercheLivres.jsp">
									<input type="search" name="searchBar" placeholder="Rechercher votre livre...">
