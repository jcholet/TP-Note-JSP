...
%>
					...
					<div class="menu">
						<ul id="nav-menu">
							...
							<li class="page_item page-item-6">
								<form action="afficheRechercheClient.jsp">
									<input type="search" name="searchBar" placeholder="Rechercher votre article...">
			...
			%>
				<h2 style="margin-left: 5.9em">Bonjour <%=session.getAttribute("nom")%></h2>
			<%
				}
			%>
