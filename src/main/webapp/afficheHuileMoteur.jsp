...
<%
	if (session.getAttribute("panier")==null) {
		...
		List<Article> articles = catalogueManager.getHuilesMoteur();
				...
				<nav id="site-navigation" class="main-navigation" role="navigation">
					...
					<div class="menu">
						<ul id="nav-menu">
							...
							<li class="page_item page-item-3 current_page_item focus">
							...
							<li class="page_item page-item-7">
								<form action="afficheRechercheHuileMoteur.jsp">
									<input type="search" name="searchBar" placeholder="Rechercher votre huile moteur...">
					...
					<div id="primary" class="content-area">
						<main id="main" class="site-main" role="main">
							<header class="woocommerce-products-header">
								<h1 class="woocommerce-products-header__title page-title">Huiles moteur</h1>
							</header>
