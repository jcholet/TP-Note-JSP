...
<%
	if (session.getAttribute("panier")==null) {
		...
		List<Article> articles = catalogueManager.getMusiques();
				...
				<nav id="site-navigation" class="main-navigation" role="navigation">
					...
					<div class="menu">
						<ul id="nav-menu">
							...
							<li class="page_item page-item-4 current_page_item focus">
							...
							<li class="page_item page-item-6">
								<form action="afficheRechercheMusique.jsp">
									<input type="search" name="searchBar" placeholder="Rechercher votre musique...">
					...
					<div id="primary" class="content-area">
						<main id="main" class="site-main" role="main">
							<header class="woocommerce-products-header">
								<h1 class="woocommerce-products-header__title page-title">Musiques</h1>
							</header>
